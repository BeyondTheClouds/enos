...
edit it to fit your situation -- {{{ie}}} something like listing
[[lst:reservation.yaml]]. Three parts of this configuration file are
...
# Kolla parameters                                #
# ############################################### #
kolla-ansible: kolla-ansible~=10.0 (ref:kolla-sec)
